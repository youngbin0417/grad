...
def train(model, NUM_EPOCHS, optimizer, DEVICE, train_loader, valid_loader, test_loader, args, start_epoch=0, best_val_acc=0):
    ...
    for epoch in range(start_epoch, NUM_EPOCHS):
        ...
        with torch.set_grad_enabled(False): # save memory during inference
            ...
            # Save EMA model for ensemble
            epoch_path = f'ensemble_model/ema_{args.type}_epoch{epoch}.pt'
            ...
            save_path_acc = f'ensemble_model/ema_{args.type}_val_accs.npy'
            save_path_worst = f'ensemble_model/ema_{args.type}_val_worsts.npy'
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        if args.type == 'baseline':
            ...
            ckpt_paths = [f'ensemble_model/ema_baseline_epoch{i}.pt' for i in range(config.base_epochs)]
            ...
            ckpt_paths = [f'ensemble_model/ema_margin_epoch{i}.pt' for i in range(config.base_epochs)]
        ...
        val_accs_path = f'ensemble_model/ema_{args.type}_val_accs.npy'
        val_worst_path = f'ensemble_model/ema_{args.type}_val_worsts.npy'
